...
#ifndef __DEF_KIWI_GUI_MOUSER__
#define __DEF_KIWI_GUI_MOUSER__
...
namespace Kiwi
{
	...
	public:
		 ...
		 */
		virtual bool receive(Event const& event) = 0;
	};
	...
	public:
		 ...
		 */
		Event(const Type type, const int x, const int y, const ulong mod) noexcept;
		...
		/** The function initializes a mouse event.
		 ...
		 @param mod     The modifiers of the mouse event.
		 */
		Event(const Type type, Point const& position, const ulong mod) noexcept;
		 ...
		 */
		Event(const Type type, const int x, const int y, const ulong mod, const double wheel_x, const double wheel_y, const bool clicked, const int down_x, const int down_y, const ulong nclicks) noexcept;
		...
		/** The function initializes a mouse event.
		 ...
		 @param nclicks the number of multiclicks.
		 */
		Event(const Type type, Point const& position, const ulong mod, Point const& wheel, const bool clicked, Point const& down_position, const ulong nclicks) noexcept;
